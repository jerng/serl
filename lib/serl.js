...
export class Node {
     ...
     *  > **Working Conclusion:** 
     *  >
     *  > Passing-by-value only, shall be managed by the user/developer, for the
     *  > time being. Following OTP convention, do not design programs to
     *  > require the passage as arguments of large datum.
     *  >
     *  > **Discussion:** 
     *  >
     ...
     *  > </ol>
     *  >
     *  > Furthermore, if (1) is picked, should it follow a convention where it
     *  > only conducts a partial clone, as is the case with most cloning
     *  > libraries, or should it attempt to fully clone methods as well?
     *  >
     *  >
     *  
     *
