 ...
 *  their 'replacer function' parameters, the [MDN docs]{@link
 ...
 *
 *  @see MDN, on JSON.parse() and JSON.stringify() using the `replacer function`
 *  argument. 
 *
