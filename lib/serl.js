    ...
    spawn () {
        ...
        switch (arguments.length) {
            ...
            case 1:
                ...
                //*
                let stringified = JSON.stringify    ( fun, serialReplacer )
                console.log ( stringified )

                let parsed      = JSON.parse        ( stringified, serialReviver )
                console.log ( parsed )
            ...
            switch ( value._serlType) {
                ...
                case 5 :            return Function ( `"use strict"; 
                    return (${value.v}).apply ( this, arguments ) ` )
                                        ...
                                        //  object itself, enabling functions
                                        //  passed to spawn/n to recurse upon
                                        //  themselves.
                                        //
                                        //  Other options:
                                        //
                                        //  spawn/n might make `this` the
                                        //  calling Proc. 
                                        //
