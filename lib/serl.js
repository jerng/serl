    ...
    spawn () {
        ...
        switch (arguments.length) {
            ...
            case 1:
                ...
                stringifiedFun  = JSON.stringify    ( fun, serialReplacer )
                parsedFun       = JSON.parse        ( stringifiedFun, serialReviver )
            ...
            case 3:
                ...
                stringifiedFun      = JSON.stringify    ( fun, serialReplacer )
                parsedFun           = JSON.parse        ( stringifiedFun, serialReviver )
                stringifiedFunArgs  = JSON.stringify    ( funArgs, serialReplacer )
                parsedFunArgs       = JSON.parse        ( stringifiedFunArgs, serialReviver )
...
/**
 *  @property module:Serl.serialReplacer
 *  
...
export let serialReplacer = (key, value) => {
...
export let serialReviver = (key, value) => {
