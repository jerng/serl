 ...
 *
 *  @property host Should mirror OTP convention, presumably refer
 *  to a hostfile.
 *
 *  @property name Analogous to an OTP [node name]{@link
 *  https://erlang.org/doc/reference_manual/distributed.html#nodes}
 *
 *  @property procMap A map of this node's processes.
 *
 *  @property nodeMap A map of connected nodes.
 *
