...
console.log (' match: before branch logic ')
                                let returnedByBranch = branch ( msg )
console.log (' match: after branch logic ')

// This code runs the first time as F1()'s body calls receive() the first time
// This code runs the second time 
